...
struct Simple_Block {
    ...
    Simple_Block (const IDT& id) : m_id (id)
    {
    }
...
struct Ranked_Block {
    ...
    Ranked_Block (const IDT& id, PRT priority) : m_id (id), m_priority (priority)
    {
    }
...
class Set_LRU
{
   ...
   protected:
    ...
    typedef typename boost::multi_index::index<LRU_Blocks, priority>::type::iterator
        priority_iterator_t;
    typedef typename boost::multi_index::index<LRU_Blocks, priority>::type::const_iterator
...
class Set_Prioritized : public Set_LRU<IDT>
{
   ...
   protected:
    ...
    typedef
        typename boost::multi_index::index<Prio_Blocks, id>::type::const_iterator id_citerator_t;

    typedef typename boost::multi_index::index<Prio_Blocks, priority>::type priority_idx_t;
    typedef typename boost::multi_index::index<Prio_Blocks, priority>::type::iterator
        priority_iterator_t;
    typedef typename boost::multi_index::index<Prio_Blocks, priority>::type::const_iterator
        priority_citerator_t;
